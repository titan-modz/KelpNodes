...
blueprint_theme_menu() {
    while true; do
        ...
        case $subchoice in
            1)
                run_remote_script "https://raw.githubusercontent.com/titan-modz/kelpnodes/refs/heads/main/blueprint.sh"
                ;;
            2)
                print_header_rule
                big_header "WELCOME"
                ...
                bash <(curl -s https://raw.githubusercontent.com/titan-modz/kelpnodes/refs/heads/main/extension.sh)
...
show_menu() {
    clear
    print_header_rule
    echo -e "${RED}           🚀 KELP HOSTING MANAGER            ${NC}"
    print_header_rule
...
while true; do
    ...
    case $choice in
        1) run_remote_script "https://raw.githubusercontent.com/titan-modz/kelpnodes/refs/heads/main/panel.sh" ;;
        2) run_remote_script "https://raw.githubusercontent.com/titan-modz/kelpnodes/refs/heads/main/wing.sh" ;;
        3) run_remote_script "https://raw.githubusercontent.com/titan-modz/kelpnodes/refs/heads/main/uninstall.sh" ;;
        4) blueprint_theme_menu ;;
        5) run_remote_script "https://raw.githubusercontent.com/titan-modz/kelpnodes/refs/heads/main/cloudflare.sh" ;;
        6) system_info ;;
        7) run_remote_script "https://raw.githubusercontent.com/titan-modz/kelpnodes/refs/heads/main/tailscale.sh" ;;
        8)
            print_header_rule
